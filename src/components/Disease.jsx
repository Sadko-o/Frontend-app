...
// COMPONENT
const Disease = () => {
    const baseURL = "https://backend-app-production-2791.up.railway.app/disease";
    ...
    //DELETE
    const deleteDisease =  (code) => {
        // console.log(cname)
        axios({
            method: 'delete',
            url: baseURL,
            data: {
                disease_code: code.disease_code,
                pathogen: code.pathogen,
                ...
                <div className="w-full lg:w-5/6">
                    <div className="bg-white shadow-xl rounded-[12px] my-6">
                        <div className=' bg-white py-3 rounded-tl-lg rounded-tr-lg  px-3 text-left flex justify-between'>
                            <h2 className=" bg-white py-2 px-2 text-[#4885ed] pb-2 text-xl font-bold sm:text-2xl">Disease</h2>
                        ...
                        <table className="min-w-max w-full table-auto">
                            <thead>
                                <tr className="bg-[#ca2125] mx-4 px-5 text-white uppercase text-sm leading-normal">
                                    <th className="py-3 px-10 text-left">Disease code</th>
                                    <th className="py-3 px-3 text-left">Pathogen</th>
                            ...
                            <tbody className="text-gray-600 text-sm font-light">
                                ...
                                <tr className="border-b border-gray-300 hover:bg-gray-200">
                                    ...
                                    <td className="py-3 px-10 text-left whitespace-nowrap">
                                        <div className="flex items-center">
                                            <span className="font-medium">{row.pathogen}</span>
                                        </div>
                                    </td>
                                    <td className="py-3 px-10 text-left whitespace-nowrap">
                                        <div className="flex items-center">
                                                                ...
                                                                <div  x-transition className="fixed top-0 left-0 flex h-full min-h-screen w-full items-center justify-center backdrop-blur-sm bg-opacity-90 px-4 py-5">
                                                                    <div className="w-full max-w-[570px] rounded-[20px] bg-white py-12 px-8 text-center md:py-[60px] md:px-[70px]">
                                                                        ...
                                                                        <div className="relative">
                                                                            <label className="text-gray-700  top-0 left-0 flex">Disease Code<span className="text-red-500 required-dot">*</span></label>
                                                                            <input 
                                                                        ...
                                                                        <div className="relative">
                                                                            <label className="text-gray-700  top-0 left-0 flex">Pathogen<span className="text-red-500 required-dot">*</span></label>
                                                                            <input 
                                                                                className="my-4 rounded-lg shadow-lg border-transparent border-[#f3f3f3] flex-1 appearance-none border  w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400  text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" 
                                                                                name="diseasetypeid"
                                                                                type="text"
                                                                        ...
                                                                        <div className=" relative ">
                                                                            <label for="required-email" className="text-gray-700 left-0 top-0 flex">Id<span className="text-red-500 required-dot">*</span>
                                                                            </label>
                                                                                <input 
                                                                                className="my-4 rounded-lg border-transparent shadow-lg flex-1 appearance-none border border-[#f3f3f3] w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                                                type="text"
                    ...
                    (
                        <div x-show="modalOpen" x-transition className="fixed top-0 left-0 flex h-full min-h-screen w-full items-center justify-center bg-[#e5e7eb] bg-opacity-90 px-4 py-5">
                            <div className="w-full max-w-[570px] rounded-[20px] bg-white py-12 px-8 text-center md:py-[60px] md:px-[70px]">
                                ...
                                {/* CNAME */}
                                <div className=" relative ">
                                    <label for="required-email " value="id" className="text-gray-700  top-0 left-0 flex">Disease Code<span className="text-red-500 required-dot">*</span></label>
                                    <input type="text" 
                                ...
                                {/*  POPULATION */}
                                <div className=" relative ">
                                    <label for="required-email" value="desctiption" className="text-gray-700 left-0 top-0 flex">Pathogen<span className="text-red-500 required-dot">*</span></label>
                                    <input type="text"  
                                    className="my-4 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" 
                                    placeholder="Paqthogen" 
                                ...
                                {/*  ID */}
                                <div className=" relative ">
                                    <label for="required-email" value="desctiption" className="text-gray-700 left-0 top-0 flex">Id<span className="text-red-500 required-dot">*</span></label>
                                    <input type="text"  
                                    className="my-4 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" 
                                    placeholder="Id" 
