...
const Doctor = () => {
    ...
    const createDiseaseType = async () => {
        ...
        await axios.post(`${baseURL}`,  {email: diseaseTypeId, degree:diseaseTypeDescription}).then((response) => {console.log(response)});
        getAllDiseaseType();
    }
    ...
    const deleteDiseaseType = async (diseaseTypeId) => {
        await axios.delete(`${baseURL}`, {data: {email: diseaseTypeId}});
        getAllDiseaseType();
    }
        ...
        <div className="overflow-x-auto">
                <div className="min-w-screen min-h-screen  flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
                    <div className="w-full lg:w-5/6">
                        ...
                        <h2 class=" bg-gray-100 py-2 text-dark pb-2 text-xl font-bold sm:text-2xl">Doctors</h2>
